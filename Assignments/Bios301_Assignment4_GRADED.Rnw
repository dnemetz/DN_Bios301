...
INSTRUCTOR COMMENTS IN ALL CAPS BELOW
...
THE FOLLOWING LINE IS MARKDOWN, AND WONT WORK IN RNW FILES.
...
THIS ISNT REALLY WHAT I WAS LOOKING FOR, GIVEN THAT THIS IS A COMPUTING COURSE, BUT SINCE THE QUESTION WAS NOT SPECIFIC, I WILL NOT PENALIZE YOU.
...
THE FOLLOWING TEXT WILL NOT WORK AT ALL IN AN RNW DOCUMENT. IF YOU ARE GOING TO USE RNW, YOU NEED TO START WITH A LATEX FILE, NOT A MARKDOWN FILE
...
THIS TABLE ALSO DOES NOT GET RENDERED PROPERLY.
...
OVERALL SCORE: 50 - 2 FOR POOR KNITR FORMATTING AND OUTPUT = 48/50
