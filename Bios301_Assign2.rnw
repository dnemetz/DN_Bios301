...
newtonraphson(test_func, function(x) -sin(x)-1)
@
...
<<>>=
#Note: In HW repo-
#with homework 1 & homework 2 files
#grab data in homework via "../data/foo.csv"
@
...
<<>>=
#from git use: data <- read.table("../data/haart.csv", sep=",", head=T)
...
<<>>=
#from git use: data <- read.table("../data/haart2.csv", sep=",", head=T)
...
#Adding new variables to dataset2
